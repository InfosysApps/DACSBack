const CheckListMod = require('../Models/CheckListModel');
...
exports.Get = () => {
    ...
    try
    {  
        return CheckListMod.Get().then(function(result){
            if(result)
            {
                //validate true
                _http.message = "CheckList found. Here are the details.";
            ...
            else
            {
                ...
                _http.message = "CheckList Not Found !! Please try again.";
    ...
    catch(error)
    {
        ...
        _http.message = "CheckList operation failed. Internal Server error.";
